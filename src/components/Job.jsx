...
const Job = ({job, dynamic}) => {
    ...
    return (
        <div className='container mx-auto flex flex-col lg:flex-row justify-between gap-8 px-4 pt-4 lg:pt-8'>
            ...
            <div className='lg:w-[40%] text-center'>
                { job.id==dynamic.jobId &&
                    <div className='border rounded-md bg-gray-100 pl-4 py-6'>
